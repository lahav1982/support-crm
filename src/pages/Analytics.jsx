        ...
        <div style={{ flex: 2 }}>
          <ChartCard title="Ticket Volume" sub="Opened vs resolved per day">
            ...
            <div style={{ display: "flex", gap: 16, marginTop: 10 }}>
              <span style={{ fontSize: 13, color: "#EF4444", fontWeight: 600, display: "flex", alignItems: "center", gap: 5 }}><span style={{ width: 8, height: 8, background: "#EF4444", borderRadius: 2, display: "inline-block" }} />Opened</span>
              <span style={{ fontSize: 13, color: "#10B981", fontWeight: 600, display: "flex", alignItems: "center", gap: 5 }}><span style={{ width: 8, height: 8, background: "#10B981", borderRadius: 2, display: "inline-block" }} />Resolved</span>
            </div>
          </ChartCard>
        </div>
        <div style={{ flex: 1 }}>
