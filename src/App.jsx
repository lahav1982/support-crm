        ...
        {NAV.map(n => {
          ...
          return (
            <button key={n.id} onClick={() => setPage(n.id)}
              style={{ display: "flex", alignItems: "center", gap: 10, padding: "9px 12px", borderRadius: 9, border: "none", background: isActive ? "#F0EFFE" : "transparent", color: isActive ? "#6366F1" : "#6B7280", cursor: "pointer", fontSize: 13.5, fontWeight: isActive ? 700 : 500, transition: "all 0.12s", textAlign: "left" }}>
        ...
        <div style={{ height: 56, background: "#fff", borderBottom: "1px solid #EAECF0", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 28px", flexShrink: 0 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            {page === "inbox" && emailCount > 0 && (
              <span style={{ background: "#FEF2F2", color: "#EF4444", fontSize: 11, fontWeight: 700, borderRadius: 20, padding: "2px 10px" }}>{emailCount} open</span>
            )}
            {page === "tickets" && ticketCount > 0 && (
              <span style={{ background: "#EFF6FF", color: "#3B82F6", fontSize: 11, fontWeight: 700, borderRadius: 20, padding: "2px 10px" }}>{ticketCount} active</span>
            )}
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            {page === "inbox" && (
